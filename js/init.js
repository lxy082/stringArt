...
StringArtGenerator.prototype.InitControls = function() {
    ...
    this.autoModeSection = document.getElementById('auto-mode-section')
    this.manualModeSection = document.getElementById('manual-mode-section')

    this.modeBox = document.getElementById('mode-box')
    this.modeBox.addEventListener('change', () => this.SwitchMode())
    ...
    this.recordNameBox = document.getElementById('record-name-box')
    ...
    this.loadRecordBtn = document.getElementById('load-record-btn')
    this.loadRecordBtn.addEventListener('click', () => this.LoadSelectedRecord())

    this.manualRemainingBox = document.getElementById('manual-remaining-box')
    this.manualStepsBox = document.getElementById('manual-steps-box')
    this.manualStepsToggle = document.getElementById('manual-steps-toggle')
    this.manualStepsToggle.addEventListener('click', () => this.ToggleStepsDisplay())

    this.manualFromBox = document.getElementById('manual-from-box')
    this.manualToBox = document.getElementById('manual-to-box')
    this.manualSubmitBtn = document.getElementById('manual-submit-btn')
    this.manualSubmitBtn.addEventListener('click', () => this.SubmitManualStep())

    this.manualFromBox.addEventListener('keydown', (e) => {
        if (e.key === 'Enter')
            this.SubmitManualStep()
    })

    this.manualToBox.addEventListener('keydown', (e) => {
        if (e.key === 'Enter')
            this.SubmitManualStep()
    })

    this.manualStatusBox = document.getElementById('manual-status-box')

    this.manualRestartBtn = document.getElementById('manual-restart-btn')
    this.manualRestartBtn.addEventListener('click', () => this.RestartManual())

    this.manualClearBtn = document.getElementById('manual-clear-btn')
    this.manualClearBtn.addEventListener('click', () => this.ClearManualCanvas())

    this.manualBackBtn = document.getElementById('manual-back-btn')
    this.manualBackBtn.addEventListener('click', () => this.ClearManualRecord())
